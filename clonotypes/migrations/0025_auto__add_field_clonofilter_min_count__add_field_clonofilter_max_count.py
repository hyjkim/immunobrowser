...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ClonoFilter.min_count'
        db.add_column(u'clonotypes_clonofilter', 'min_count',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)

        # Adding field 'ClonoFilter.max_count'
        db.add_column(u'clonotypes_clonofilter', 'max_count',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ClonoFilter.min_count'
        db.delete_column(u'clonotypes_clonofilter', 'min_count')

        # Deleting field 'ClonoFilter.max_count'
        db.delete_column(u'clonotypes_clonofilter', 'max_count')
