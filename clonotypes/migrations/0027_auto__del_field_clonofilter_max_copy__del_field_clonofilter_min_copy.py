...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ClonoFilter.max_copy'
        db.delete_column(u'clonotypes_clonofilter', 'max_copy')

        # Deleting field 'ClonoFilter.min_copy'
        db.delete_column(u'clonotypes_clonofilter', 'min_copy')


    def backwards(self, orm):
        # Adding field 'ClonoFilter.max_copy'
        db.add_column(u'clonotypes_clonofilter', 'max_copy',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)

        # Adding field 'ClonoFilter.min_copy'
        db.add_column(u'clonotypes_clonofilter', 'min_copy',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)
