...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Rearrangement.amino_acid'
        db.add_column('clonotypes_rearrangement', 'amino_acid',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['clonotypes.AminoAcid'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Rearrangement.amino_acid'
        db.delete_column('clonotypes_rearrangement', 'amino_acid_id')
    ...
    models = {
        ...
        'clonotypes.rearrangement': {
            ...
            'amino_acid': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['clonotypes.AminoAcid']", 'null': 'True'}),
            'd3_deletion': ('django.db.models.fields.IntegerField', [], {}),
            'd5_deletion': ('django.db.models.fields.IntegerField', [], {}),
            'd_gene_name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'd_index': ('django.db.models.fields.IntegerField', [], {}),
