...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ClonoFilter.norm_factor'
        db.add_column('clonotypes_clonofilter', 'norm_factor',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ClonoFilter.norm_factor'
        db.delete_column('clonotypes_clonofilter', 'norm_factor')
    ...
    models = {
        'clonotypes.clonofilter': {
            ...
            'norm_factor': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
