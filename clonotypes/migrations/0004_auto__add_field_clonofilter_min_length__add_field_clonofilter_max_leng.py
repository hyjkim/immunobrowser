...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ClonoFilter.min_length'
        db.add_column('clonotypes_clonofilter', 'min_length',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)

        # Adding field 'ClonoFilter.max_length'
        db.add_column('clonotypes_clonofilter', 'max_length',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ClonoFilter.min_length'
        db.delete_column('clonotypes_clonofilter', 'min_length')

        # Deleting field 'ClonoFilter.max_length'
        db.delete_column('clonotypes_clonofilter', 'max_length')
