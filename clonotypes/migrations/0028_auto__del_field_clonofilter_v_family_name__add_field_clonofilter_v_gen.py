...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ClonoFilter.v_family_name'
        db.delete_column(u'clonotypes_clonofilter', 'v_family_name')

        # Adding field 'ClonoFilter.v_gene_name'
        db.add_column(u'clonotypes_clonofilter', 'v_gene_name',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'ClonoFilter.v_family_name'
        db.add_column(u'clonotypes_clonofilter', 'v_family_name',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True),
                      keep_default=False)

        # Deleting field 'ClonoFilter.v_gene_name'
        db.delete_column(u'clonotypes_clonofilter', 'v_gene_name')
