...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('clonotypes_rearrangement', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal('clonotypes', ['Rearrangement'])


        # Changing field 'AminoAcid.sequence'
        db.alter_column('clonotypes_aminoacid', 'sequence', self.gf('django.db.models.fields.CharField')(max_length=300))

    def backwards(self, orm):
        # Deleting model 'Rearrangement'
        db.delete_table('clonotypes_rearrangement')


        # Changing field 'AminoAcid.sequence'
        db.alter_column('clonotypes_aminoacid', 'sequence', self.gf('django.db.models.fields.CharField')(max_length=100))
