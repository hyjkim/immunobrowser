...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ClonoFilter.norm_factor'
        db.alter_column('clonotypes_clonofilter', 'norm_factor', self.gf('django.db.models.fields.FloatField')(null=True))

    def backwards(self, orm):

        # Changing field 'ClonoFilter.norm_factor'
        db.alter_column('clonotypes_clonofilter', 'norm_factor', self.gf('django.db.models.fields.IntegerField')(null=True))
