...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ClonoFilter.j_gene_name'
        db.add_column(u'clonotypes_clonofilter', 'j_gene_name',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ClonoFilter.j_gene_name'
        db.delete_column(u'clonotypes_clonofilter', 'j_gene_name')
