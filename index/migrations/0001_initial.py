...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SampleToAmino'
        db.create_table(u'index_sampletoamino', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sample', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['samples.Sample'], unique=True)),
            ('_amino_acids', self.gf('django.db.models.fields.TextField')(null=True, db_column='amino_acids')),
        ))
        db.send_create_signal(u'index', ['SampleToAmino'])

        # Adding model 'ClonoFilterToAmino'
        db.create_table(u'index_clonofiltertoamino', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('clonofilter', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['clonotypes.ClonoFilter'], unique=True)),
            ('_amino_acids', self.gf('django.db.models.fields.TextField')(null=True, db_column='amino_acids')),
        ))
        db.send_create_signal(u'index', ['ClonoFilterToAmino'])


    def backwards(self, orm):
        # Deleting model 'SampleToAmino'
        db.delete_table(u'index_sampletoamino')

        # Deleting model 'ClonoFilterToAmino'
        db.delete_table(u'index_clonofiltertoamino')
