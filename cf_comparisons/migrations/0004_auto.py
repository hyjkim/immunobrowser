...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.create_table(u'cf_comparisons_comparison_clonofilters', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('comparison', models.ForeignKey(orm[u'cf_comparisons.comparison'], null=False)),
            ('clonofilter', models.ForeignKey(orm[u'clonotypes.clonofilter'], null=False))
        ))
        db.create_unique(u'cf_comparisons_comparison_clonofilters', ['comparison_id', 'clonofilter_id'])
