...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'lit_search_article', 'article_id', self.gf('django.db.models.fields.IntegerField')(max_length=12))

    def backwards(self, orm):

        # Changing field 'Article.article_id'
        db.alter_column(u'lit_search_article', 'article_id', self.gf('django.db.models.fields.IntegerField')())

    models = {
        u'lit_search.article': {
            'Meta': {'object_name': 'Article'},
            'abstract': ('django.db.models.fields.TextField', [], {'null': 'True'}),
            'article_id': ('django.db.models.fields.IntegerField', [], {'max_length': '12'}),
