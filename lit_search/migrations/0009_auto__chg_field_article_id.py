...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Article.id'
        db.alter_column(u'lit_search_article', 'id', self.gf('django.db.models.fields.CharField')(max_length=12, primary_key=True))

    def backwards(self, orm):

        # Changing field 'Article.id'
        db.alter_column(u'lit_search_article', 'id', self.gf('django.db.models.fields.BigIntegerField')(primary_key=True))
