...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Article.pmcid'
        db.delete_column(u'lit_search_article', 'pmcid')

        # Adding field 'Article.pmc_id'
        db.add_column(u'lit_search_article', 'pmc_id',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Article.pmcid'
        db.add_column(u'lit_search_article', 'pmcid',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)

        # Deleting field 'Article.pmc_id'
        db.delete_column(u'lit_search_article', 'pmc_id')
